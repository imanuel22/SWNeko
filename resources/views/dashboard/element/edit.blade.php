...
<div class="card mb-3">
    ...
    <div class="card-body text-center">
        <form method="post" action="/dashboard/element/{{$element->slug}}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="row">
                <div class="col-sm-6 mb-3">
                    <label for="" class=" form-label @error('name')is-invalid @enderror">Name</label>
                    <input type="text" name="name" class=" form-control" id="name" value="{{ old('name',$element->name) }}">
                    @error('name')
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="text" name="slug" readonly class=" form-control" id="slug" value="{{ old('slug',$element->slug) }}">
                    @error('slug')
                        <div class=" invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12 mb-3">
                    ...
                    @if ($element->image)
                    <img class="img-preview img-fluid mb-3 d-block" src="{{ asset('storage/'.$element->image)}}">
                    @else
